...
import com.wangyz.wx.adapter.WxArticleAdapter;
...
import com.wangyz.wx.presenter.WxArticleFragmentPresenter;
...
public class WxArticleFragment extends BaseFragment<Contract.WxArticleFragmentView, WxArticleFragmentPresenter> implements Contract.WxArticleFragmentView {
    ...
    protected int getContentViewId() {
        return R.layout.wx_fragment_wx_article;
    }
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        mSmartRefreshLayout = rootView.findViewById(R.id.fragment_wx_article_refresh);
        mRecyclerView = rootView.findViewById(R.id.fragment_wx_article_list);
