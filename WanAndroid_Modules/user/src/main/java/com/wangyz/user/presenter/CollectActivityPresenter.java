...
import com.wangyz.user.model.CollectActivityModel;
...
public class CollectActivityPresenter extends BasePresenter<Contract.CollectActivityView> implements Contract.CollectActivityPresenter {
    ...
    public void unCollect(int articleId) {
        ...
        mModel.unCollect(articleId).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribe(new Observer<com.wangyz.common.bean.model.Collect>() {
            @Override
            public void onSubscribe(Disposable d) {
                LogUtils.i();
                mCompositeDisposable.add(d);
            ...
            @Override
            public void onNext(com.wangyz.common.bean.model.Collect result) {
                LogUtils.i();
                if (isViewAttached()) {
